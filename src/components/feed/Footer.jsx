...
export default function Footer() {
  return (
    <footer className="mt-8 mb-16 pt-10 border-t-2 border-gray-200/80 text-center flex flex-col items-center">
      ...
      <h4 className="font-playfair text-xl font-bold text-ink tracking-wide uppercase">
        Tạp Chí Pi — Diễn Đàn Toán Học
      </h4>
      <p className="font-newsreader text-base text-gray-500 max-w-lg mt-1.5 leading-relaxed">
        Kho tài liệu đề bài toán học chọn lọc và lời giải chuyên đề dành cho học sinh, sinh viên và bạn đọc yêu Toán.
      </p>
      <div className="flex flex-wrap justify-center items-center gap-3 text-xs text-gray-400 font-mono mt-5">
        <span>© 2026 Tạp Chí Pi</span>
        <span>•</span>
        <span className="text-cerulean font-bold">Pimaga React v2.0</span>
        <span>•</span>
