...
export default function FilterBar({
  ...
  return (
    <section className="flex flex-col lg:flex-row justify-between items-stretch lg:items-end gap-6 mb-10 bg-paperDark dark:bg-nightCard p-6 md:p-7 rounded-xl border border-gray-200/80 dark:border-slate-700/80 shadow-inner transition-colors duration-200">
